...
#include "lidar_imu_interfaces/msg/pose6_d.hpp"
#include "lidar_imu_interfaces/msg/states.hpp"
...
#define DEBUG_FILE_DIR(name)     ament_index_cpp::get_package_share_directory("lidar_imu_init2") + "/Log/"+ name 
#define RESULT_FILE_DIR(name)    ament_index_cpp::get_package_share_directory("lidar_imu_init2")  + "/result/"+ name

typedef lidar_imu_interfaces::msg::Pose6D     Pose6D;
